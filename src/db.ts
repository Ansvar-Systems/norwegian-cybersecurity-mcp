/**
 * SQLite database access layer for the NSM (Norwegian Cybersecurity) MCP server.
 *
 * Schema:
 *   - guidance    — NSM guidelines, Grunnprinsipper for IKT-sikkerhet, and recommendations
 *   - advisories  — NorCERT security advisories and vulnerability alerts
 *   - frameworks  — NSM framework series (Grunnprinsipper, NIS2-NO, digital sikkerhet)
 *
